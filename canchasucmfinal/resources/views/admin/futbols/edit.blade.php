          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Editar Horario</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div class="modal-body">
                  {!! Form::open(['route' => ['futbolhorarios.update',$horario->id], 'method' => 'PUT']) !!}
                      ...
                      <div class="row">
                        <div class="col-sm">
                          {!! Form::select('hora', array(
                            ...
                            '20:00' => '20:00', 
                            '21:00' => '21:00', 
                            ), $horario->hora, ['class' => 'form-control', 'placeholder' => 'Hora', 'required']) !!}
                        </div>
