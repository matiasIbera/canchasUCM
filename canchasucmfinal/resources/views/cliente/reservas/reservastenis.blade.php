...
<body>
	...
	<div class="content">
	    <h1> Reservas de Tenis del día </h1>
	        ...
	        <table class="table table-hover">
	            ...
	            <tbody>
	                ...
	                @foreach($reservas as $reserva)
						...
						<td>{{ $reserva->horariotenis2->hora }}</td>               
	                    </tr>      
	                @endforeach
    ...
    <a href="{{route('cliente.mostrart')}}" class="btn btn-primary"> Preguntar por otra fecha</a>
    <a href="{{route('cliente.reservat.create')}}" class="btn btn-success">Reservar</a>
