            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="anio_ingreso" class="col-md-4 col-form-label text-md-right">{{ __('Año ingreso') }}</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" id ="anio_ingreso" name="anio_ingreso" required>
                            </div>
                        </div>
